  ...
  return (
    <div className="app-shell">
      ...
      <main className="content">
        ...
        {tab === 'battle' && <><datalist id="battle-species-list">{bootstrap.regulation.species.map((entry) => <option key={entry.id} value={entry.name} />)}</datalist><BattleAssistant team={selectedTeam} onHistory={setHistory} /></>}
